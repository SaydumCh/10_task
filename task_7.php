...
$sql = $pdo->prepare("SELECT * FROM tasks_tb");
$sql->execute();
                               ...
                               <?php if ($user['ban'] == true):?>
                                        <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                            ...
                                            <div class="ml-2 mr-3">
                                                ...
                                                <a href="<?php echo $user['twitter_link']?>" class="text-info fs-sm" target="_blank"><?php echo $user['twitter_text']?></a> -
                                                <a href="<?php echo $user['email_link']?>" class="text-info fs-sm" target="_blank" title="<?php echo $user['email_link_title']?>"><?php echo $user['email_link_text']?></a>
                                            </div>
                                        </div>
                               <?php else:?>
